@{
    ...
    Nodes = @(
        @{ Name = 'azljkt01n1'; HostIP = '10.8.230.232'; iDRAC = '10.8.230.84'; ServiceTag = 'JF7C7J3'; MgmtMac = '34:80:0D:2E:7B:B0' }
        @{ Name = 'azljkt01n2'; HostIP = '10.8.230.235'; iDRAC = '10.8.230.86'; ServiceTag = '1G7C7J3'; MgmtMac = '34:80:0D:2E:8B:88' }
    )
}
