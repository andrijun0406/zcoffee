...
| Field | Value |
|-------|-------|
| Generated | 8/15/2026, 12:47:51 PM |
| Scenario | connected |
...
| Port | Speed | RDMA |
|------|-------|------|
| Integrated NIC1 Port 1-1 | 10GbE | No |
| Integrated NIC1 Port 2-1 | 10GbE | No |
...
| IP Pool Range | `10.8.230.132 - 10.8.230.137` |
...
|------|------|------------|
| 1 | azljkt01n1 | `10.8.230.71` |
| 2 | azljkt01n2 | `10.8.230.72` |
...
| ✅ | No SDN features selected (management not required) | Wizard hides SDN management section when no features are selected. |
...
**Infra Range:** `10.8.230.132 - 10.8.230.137`
...
- No SDN features selected; SDN management is not required.

---

*Generated by ODIN for Azure Local - 2026-08-15T05:47:51.565Z*